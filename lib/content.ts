...
export type Content = { appearance?: { style?: 'editorial' | 'cyberpunk' | 'terminal'; font: 'sans' | 'serif'; spacing: 'compact' | 'relaxed' }; aiOptions?: AIOptions; name: string; role: string; intro: string; email: string; whatsapp: string; location: string; headline: string; entries: Entry[]; seo: { title: string; description: string; noindex?: boolean; imageId?: string }; settings: { safeMode?: boolean; exploration?: boolean; projectImages?: boolean; motion: boolean; ai: boolean; maintenance: boolean; theme: 'light' | 'dark'; aiModel: string; aiBaseUrl: string; aiPrompt: string; whatsappMessage: string } };
const services = [
